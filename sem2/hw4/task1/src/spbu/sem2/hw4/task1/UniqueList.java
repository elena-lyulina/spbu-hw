 ...
 */
public class UniqueList<Type extends Comparable> extends LinkedList<Type> implements List<Type> {
    ...
    /**
     * This function add an element to UniqueList.
     *
   ...
   @Override
    ...
    /**
     * This function remove an element to UniqueList.
    ...
    /**
     * This function check existence of element in UniqueList.
     *
    ...
    public static class ElementDoesExist extends RuntimeException {
        public ElementDoesExist() {
            super("This element is in the UniqueList");
        }
    }
    ...
    public static class ElementDoesntExist extends RuntimeException {
        public ElementDoesntExist() {
            super("This element isn't in the UniqueList");
        }
    }
}
